...
my_path_4 <- "~/Research/Research---ST426/Data/PartnershipData/OverseaMerge/"

setwd(my_path_4)

df_names_4 <- list.files(pattern = "*.csv")

head(df_names_4)

to_path_4 <- "~/Research/Research---ST426/Data/FinalData/partnership/overseas/"
...
lapply(df_names_4, FUN = surv_data , write_path = to_path_4)
...
my_path_1 <- "~/Research/Research---ST426/Data/PlayerData/Home/"

setwd(my_path_1)

df_names_1 <- list.files(pattern = "*.csv")

head(df_names_1)

to_path_1 <- "~/Research/Research---ST426/Data/FinalData/player/home/"
...
lapply(df_names_1, FUN = surv_data , write_path = to_path_1)
